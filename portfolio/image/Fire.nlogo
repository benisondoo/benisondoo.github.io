...
to setup
  ...
  ask patches with [(random-float 125) < density] ;; changed variable for how close and how many grass patches there are
    [ set pcolor green ]
...
to fade-embers
  ask embers
    [ set color color + 0.1  ;; make red darker
      if color > red + 1.1    ;; are we almost at black?
        [set pcolor color
          die ]]
  ask embers
  [ if humidity = 0 and type-of-wood = "birch"
    [set color color + .5
      if color > red + .25
      [set pcolor black + 2.75
      die ]]]
  ask embers
  [ if humidity > 0 and humidity < 20 and type-of-wood = "birch"
    [set color color + .15
      if color > red + .25
      [set pcolor black + 2.75
      die ]]]
  ask embers
  [ if humidity >= 20 and humidity < 50 and type-of-wood = "birch"
    [set color color + .15     if color > red + .20
      [set pcolor black + 2.75
       die ]]]
  ask embers
    [ if humidity >= 50 and type-of-wood = "birch"
      [set color color + .005
       if color > red + .15
       [set pcolor black + 2.75
         die ]]]
  ...
  ask embers
  [ if humidity = 0 and type-of-wood = "douglas-fir"
    [set color color + .5
      if color > red + .20
      [set pcolor black + 1
      die ]]]
  ask embers
  [ if humidity > 0 and humidity < 20 and type-of-wood = "douglas-fir"
    [set color color + .15
      if color > red + .20
      [set pcolor black + 1
      die ]]]
  ask embers
  [ if humidity >= 20 and humidity < 50 and type-of-wood = "douglas-fir"
    [set color color + .15
      if color > red + .15
      [set pcolor black + 1
       die ]]]
  ask embers
    [ if humidity >= 50 and type-of-wood = "douglas-fir"
      [set color color + .005
       if color > red + .10
       [set pcolor black + 1
         die ]]]
  ...
  ask embers
  [ if humidity = 0 and type-of-wood = "spruce"
    [set color color + .5
      if color > red + .15
      [set pcolor black + 0.5
      die ]]]
  ask embers
  [ if humidity > 0 and humidity < 20 and type-of-wood = "spruce"
    [set color color + .15
      if color > red + .15
      [set pcolor black + 0.5
      die ]]]
  ask embers
  [ if humidity >= 20 and humidity < 50 and type-of-wood = "spruce"
    [set color color + .15
      if color > red + .10
      [set pcolor black + 0.5
       die ]]]
  ask embers
    [ if humidity >= 50 and type-of-wood = "spruce"
      [set color color + .005
       if color > red + .05
       [set pcolor black + 0.5
         die ]]]
